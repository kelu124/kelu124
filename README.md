...
#### Python APIs & Software

- **[pyusbus](https://github.com/kelu124/pyusbus)** ⭐ 28 - Python APIs for USB ultrasound probes
- **[pyUProbe1](https://github.com/kelu124/pyUProbe1)** ⭐ 15 - Python library for uProbe-1 ultrasound probe acquisitions

#### Experimental & AI Projects

- **[awesome-latticeFPGAs](https://github.com/kelu124/awesome-latticeFPGAs)** ⭐ 349 - Curated list of Lattice FPGA boards using open tools
- **[frugalai-challenge_pico](https://github.com/kelu124/frugalai-challenge_pico)** ⭐ 2 - TinyML inference on RP2040 microcontroller
...
- **[python-usb-un0rick](https://github.com/kelu124/python-usb-un0rick)** ⭐ 4 - USB interface library for un0rick hardware
- **[pyUn0-lib](https://github.com/kelu124/pyUn0-lib)** ⭐ 5 - Python 3 library for un0rick platform

- **[us_rf_processing](https://github.com/kelu124/us_rf_processing)** ⭐ 26 - Demonstrating B-mode ultrasound image reconstruction from RF data
- **[openultrasoundprojects](https://github.com/kelu124/openultrasoundprojects)** ⭐ 21 - Curated collection of open-source ultrasound projects
...
- **[HV9150DevKit](https://github.com/kelu124/HV9150DevKit)** ⭐ 6 - Development board for the HV9150 high voltage IC
- **[DAC2932](https://github.com/kelu124/DAC2932)** ⭐ 5 - RP2040-controlled fast DAC with 6 configurable outputs
- **[PMOD_rp2040](https://github.com/kelu124/PMOD_rp2040)** ⭐ 5 - Signal acquisition and transmission modules using PMOD standard
- **[max14866](https://github.com/kelu124/max14866)** ⭐ 3 - MAX14866 16-channel high voltage switch breakout
- **[ADC08200-PMOD](https://github.com/kelu124/ADC08200-PMOD)** ⭐ 3 - ADC08200 high-speed analog-to-digital converter PMOD module
- **[bomanz](https://github.com/kelu124/bomanz)** ⭐ 20 - High-speed Raspberry Pi HAT for data acquisition
